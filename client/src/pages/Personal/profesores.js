...
export default function Profesores() {
    ...
    const [nombreAreaEmpleado, setNombreAreaEmpleado] = useState('P');
    ...
    const [titulo, setTitulo] = useState(nombreAreaEmpleado === 'P' ? "Profesor" : "No identificado");
        ...
        <div className="fondo">
            <nav className="BarraNavegacion">
                <div className="contenedorBarra b1">
                    ...
                    <ul>
                        <li><a onClick={() => { window.location.reload(); }}>Profesores</a></li>
                    </ul>
                </div>
                    ...
                    <div className="modal-content">
                        ...
                        <div className='registro'>
                            ...
                            <Card onClick={activarProfesor} style={{ display: 'flex', width: '18rem', margin: 'auto', padding: '2em', cursor: 'pointer' }}>
                                ...
                                <Card.Body style={{ display: 'flex', margin: 'auto' }}>
                                    <Card.Title>Activar Profesor</Card.Title>
                                </Card.Body>
                            </Card>
                        </div>
                    </div>
                        ...
                        <div className='datos'>
                            ...
                            <div className='grupoDatos3'>
                                <Card style={{ width: '18rem', margin: '1em' }}>
                                    ...
                                    <ListGroup variant="flush">
                                        <ListGroup.Item>{nombreAreaEmpleado === 'P' ? "Profesor" : "No identificado"}</ListGroup.Item>
                                    </ListGroup>
                                </Card>
                                <Card style={{ width: '18rem', margin: '1em' }}>
