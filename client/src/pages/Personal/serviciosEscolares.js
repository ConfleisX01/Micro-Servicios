...
export default function ServiciosEscolares() {
    ...
    const [nombreAreaEmpleado, setNombreAreaEmpleado] = useState('SE');
    ...
    const [titulo, setTitulo] = useState(nombreAreaEmpleado === 'SE' ? "Servicios Escolares" : "No identificado");
        ...
        <div className="fondo">
            <nav className="BarraNavegacion">
                <div className="contenedorBarra b1">
                    ...
                    <ul>
                        <li><a onClick={() => { window.location.reload(); }}>Servicios Escolares</a></li>
                    </ul>
                </div>
            ...
            <div className="contenido">
                <div className="titulo">
                    <h1>GESTIÓN DE SERVICIOS ESCOLARES</h1>
                </div>
            </div>
                ...
                <div className="modal">
                    <div className="modal-content">
                        <div className='headerModal'>
                            ...
                            <h2>Registrar Servicio Escolar</h2>
                            ...
                            <div style={{ width: '50%', paddingLeft: '0.5em', textAlign: 'center' }}>
                                ...
                                <InputGroup className="mb-3 custom-input-group">
                                    ...
                                    <Form.Control
                                        ...
                                        aria-label="Default"
                                        aria-describedby="inputGroup-sizing-default"
                                        placeholder='Ej. Atención y Orientación'
                                    />
                                </InputGroup>
                ...
                <div className="modal">
                    <div className="modal-content">
                        <div className='headerModal'>
                            ...
                            <h2>Opciones Servicio Escolar</h2>
                        ...
                        <div className='registro'>
                            ...
                            <Card onClick={eliminarProfesor} style={{ display: 'flex', width: '18rem', margin: 'auto', padding: '2em', cursor: 'pointer' }}>
                                ...
                                <Card.Body style={{ display: 'flex', margin: 'auto' }}>
                                    <Card.Title>Eliminar SE</Card.Title>
                                </Card.Body>
                            </Card>
                        </div>
                    </div>
                    ...
                    <div className="modal-content">
                        ...
                        <div className='registro'>
                            ...
                            <Card onClick={activarProfesor} style={{ display: 'flex', width: '18rem', margin: 'auto', padding: '2em', cursor: 'pointer' }}>
                                ...
                                <Card.Body style={{ display: 'flex', margin: 'auto' }}>
                                    <Card.Title>Activar SE</Card.Title>
                                </Card.Body>
                            </Card>
                        </div>
                    </div>
                ...
                <div className="modal">
                    <div className="modal-content">
                        <div className='headerModal'>
                            ...
                            <h2>Ver Detalles Servicios Escolares</h2>
                        ...
                        <div className='datos'>
                            ...
                            <div className='grupoDatos3'>
                                <Card style={{ width: '18rem', margin: '1em' }}>
                                    ...
                                    <ListGroup variant="flush">
                                        <ListGroup.Item>{nombreAreaEmpleado === 'SE' ? "Servicios Escolares" : "No identificado"}</ListGroup.Item>
                                    </ListGroup>
                                </Card>
                                <Card style={{ width: '18rem', margin: '1em' }}>
