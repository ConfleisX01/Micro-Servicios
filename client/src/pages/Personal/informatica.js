...
export default function Profesores() {
    ...
    const [nombreAreaEmpleado, setNombreAreaEmpleado] = useState('I');
    ...
    const [titulo, setTitulo] = useState(nombreAreaEmpleado === 'I' ? "Informatica" : "No identificado");
        ...
        <div className="fondo">
            <nav className="BarraNavegacion">
                <div className="contenedorBarra b1">
                    ...
                    <ul>
                        <li><a onClick={() => { window.location.reload(); }}>Informática</a></li>
                    </ul>
                </div>
                    ...
                    <div className="modal-content">
                        ...
                        <div className='registro'>
                            ...
                            <Card onClick={eliminarProfesor} style={{ display: 'flex', width: '18rem', margin: 'auto', padding: '2em', cursor: 'pointer' }}>
                                ...
                                <Card.Body style={{ display: 'flex', margin: 'auto' }}>
                                    <Card.Title>Eliminar Informatico</Card.Title>
                                </Card.Body>
                            </Card>
                        </div>
                    </div>
                    ...
                    <div className="modal-content">
                        ...
                        <div className='registro'>
                            ...
                            <Card onClick={activarProfesor} style={{ display: 'flex', width: '18rem', margin: 'auto', padding: '2em', cursor: 'pointer' }}>
                                ...
                                <Card.Body style={{ display: 'flex', margin: 'auto' }}>
                                    <Card.Title>Activar Informatico</Card.Title>
                                </Card.Body>
                            </Card>
                        </div>
                    </div>
                ...
                <div className="modal">
                    <div className="modal-content">
                        <div className='headerModal'>
                            ...
                            <h2>Ver Detalles Informatico</h2>
                        ...
                        <div className='datos'>
                            ...
                            <div className='grupoDatos3'>
                                <Card style={{ width: '18rem', margin: '1em' }}>
                                    ...
                                    <ListGroup variant="flush">
                                        <ListGroup.Item>{nombreAreaEmpleado === 'I' ? "Informática" : "No identificado"}</ListGroup.Item>
                                    </ListGroup>
                                </Card>
                                <Card style={{ width: '18rem', margin: '1em' }}>
